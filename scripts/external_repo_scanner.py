...
class ExternalRepoScanner:
	...
	def _analyze_structure(self, path: Path, max_depth: int = 3, current_depth: int = 0) -> Tuple[int, set, list]:
		"""
	...
	def _analyze_github_contents(self, contents: List[Dict]) -> Tuple[int, set, list]:
	...
	def _infer_languages(self, extensions: set) -> List[str]:
