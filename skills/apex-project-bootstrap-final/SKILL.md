...
description: Start every Oracle APEX project with the final canonical workspace, dependency, source-cloning, decision-precedence, compatibility policies, and Codex Desktop MCP readiness. Use before design, implementation, QA, or documentation work in any new APEX project.
---
...
Consult the repository document `docs/inicializacion-automatica-codex.md` for setup frequency and operational limits.
