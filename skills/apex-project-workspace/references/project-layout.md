...
Every change folder must retain the numbered execution sequence, decision record, implementation plan, evidence, and rollback material required by `oracle-data-change-governance`.
