...
description: "Design APEX applications and pages from approved business requirements."
---
...
2. Classify patterns from `apex-pattern-mining-safe` as **adopt**, **adapt**, or **do not reuse**. Do not copy IDs, business SQL, secrets, or custom code blindly.
